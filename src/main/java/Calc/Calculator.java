...
class Calculator {
    ...
    public String performCalculation() {
        ...
        if (parts.length != 3) {
            throw new CalculatorException(
                    "Некорректный формат. Ожидается: [число][оператор][число], например: 3+7 или 3 - 7");
        }
        ...
        if (operandA < 1 || operandA > 10) {
            throw new CalculatorException(
                    "Число " + operandA + " не должно быть меньше 1 или больше 10");

        }
        if (operandB < 1 || operandB > 10) {
            throw new CalculatorException(
                    "Число " + operandB + " не должно быть меньше 1 или больше 10");
        }
        ...
        switch (operator) {
            ...
            default:
                throw new CalculatorException(
                        "Некорректная операция. Поддерживаются +, -, *, /");
        }
    ...
    private int parseNumber(String str) {
        try {
            ...
            throw new CalculatorException(
                    "Некорректное число: \"" + str + "\". Ожидаются целые числа.");
        }
    }
}
